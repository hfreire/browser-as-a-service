...
```
git clone https://github.com/my-github-username/browser-as-a-service
```
...
Add remote upstream
```
git remote add upstream https://github.com/hfreire/browser-as-a-service
```
...
The list of outstanding feature requests and bugs can be found in the [GitHub issue tracker](https://github.com/hfreire/browser-as-a-service/issues) of this repo. Please, feel free to propose features or report bugs that are not there.
...
Once you generate a pull request, GitHub and third-party apps will verify if the changes are suitable to be merged with upstream. [GitHub Actions CI workflow](https://github.com/hfreire/browser-as-a-service/actions?workflow=ci) will verify your changes for style guide violations and failing test cases, while, [Coveralls](https://coveralls.io/github/hfreire/browser-as-a-service) will verify the coverage of the automated test cases against the code.
